...
public:
    ...
    Q_INVOKABLE void updateCommandParams(int robotID,int velX,int velY,int velR,bool ctrl,bool mode,bool shoot,int power){
        radioPacket.updateCommandParams(robotID,velX,velY,velR,ctrl,mode,shoot,power);
    }
private:
    QStringList ports;
